...
layout: default
---
# CoreLibs_ErrorCodeToUIMappingSelector
...
Returns the relevant mappings for the provided error codes

#### Parameters

|Param|Description|
|---|---|
|`errorCodes`|error codes to retrieve mappings fr|

#### Returns

|Type|Description|
|---|---|
|`List<CoreLibs_ErrorCodeToUIMessageMapping__mdt>`|Results from the query|
